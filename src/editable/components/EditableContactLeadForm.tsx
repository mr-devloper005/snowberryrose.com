  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 rounded-sm border border-[var(--editable-border)] bg-[var(--slot4-panel-bg)] p-6 md:p-8">
      ...
      <button
        ...
        className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-[rgba(255,255,255,0.12)] bg-[#1e1e1e] px-6 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-[#2a2a2a] disabled:cursor-not-allowed disabled:opacity-70"
      >
