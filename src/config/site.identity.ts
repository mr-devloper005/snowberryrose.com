export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'snowberryrose',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Snowberryrose',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'snowberryrose.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://snowberryrose.com',
